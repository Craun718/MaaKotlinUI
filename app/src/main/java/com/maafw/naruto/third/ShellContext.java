...
/**
 * 伪造的 Android Context，用于在无 Activity 的进程中获取系统服务。
 */
public final class ShellContext extends ContextWrapper {
    ...
    private ShellContext() {
        super(MaaFwCompat.getSystemContext());
    }
    ...
    public PackageManager getPackageManager() {
        try {
            ...
            Log.w("ShellContext", "getPackageManager failed", e);
    ...
    public AttributionSource getAttributionSource() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            try {
                ...
                Log.w("ShellContext", "getAttributionSource failed", e);
            }
        }
